...
class iouEval:
    ...
    def addBatch(self, x, y):   #x=preds, y=targets
        ...
        # print(x.shape) # torch.Size([1, 1, 512, 1024])
        # print(y.shape) # torch.Size([1, 1, 512, 1024])
        ...
        #print(type(x_onehot))
        #print(type(y_onehot))
        # print(x_onehot.size())    torch.Size([1, 19, 512, 1024])
        # print(y_onehot.size())    torch.Size([1, 19, 512, 1024])
